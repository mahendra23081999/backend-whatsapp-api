...
// In your InstallController.js or wherever getLicense is defined

export async function getLicense(req, res) {
  // BYPASS: Skip license, mark as valid, go to database
  req.app.locals.licenseValidated = true;
  
  // Or store in session/database
  await saveLicenseStatus({ verified: true, bypassed: true });
